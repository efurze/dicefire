...
var Globals = require('../public/js/app/globals');
...
ConsoleLevels[Globals.CHANNEL.SERVER] 					= Globals.LEVEL.INFO;
ConsoleLevels[Globals.CHANNEL.SERVER_SOCKET] 			= Globals.LEVEL.INFO;
ConsoleLevels[Globals.CHANNEL.USER_AI] 					= Globals.LEVEL.DEBUG;
ConsoleLevels[Globals.CHANNEL.GAME] 					= Globals.LEVEL.INFO;
ConsoleLevels[Globals.CHANNEL.ADMIN] 					= Globals.LEVEL.INFO;
...
module.exports = {
	...
	// USAGE: logger.log("my msg", foo, bar, ... baz, logger.LEVEL.INFO, logger.CHANNEL.ENGINE, gameId /*optional*/);
	log: function(vargs) {
	...
	ASSERT: function (condition) {
			if (!condition) {
				try {
					...
					module.exports.log("ASSERTION FAILURE", err.stack, Globals.LEVEL.ERROR, Globals.CHANNEL.DEFAULT);
				} catch (e) {}
