...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    concat: {
      ...
      dist: {
        src: ['public/js/app/**/*.js', '!public/js/test.js', '!public/test/*.js'],
    ...
    jshint: {
      files: ['Gruntfile.js', 'public/js/app/**/*.js', 'test/**/*.js', 'index.js', 'controllers/**/*.js', 'lib/**/*.js'],
      options: {
    ...
    watch: {
      ...
      tasks: ['sass', 'jshint', 'concat', 'uglify'] //['qunit']
    },
    nodemon: {
        dev: {
          options: {
